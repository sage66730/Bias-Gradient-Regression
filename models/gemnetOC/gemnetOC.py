...
from .compat import load_scales_compat
...
class GemNetOC(torch.nn.Module):
    ...
    def __init__(
        ...
        cutoff: float = 12.0,
        cutoff_qint: Optional[float] = 12.0,
        cutoff_aeaint: Optional[float] = 12.0,
        cutoff_aint: Optional[float] = 12.0,
        max_neighbors: int = 30,
        max_neighbors_qint: Optional[int] = 8,
        max_neighbors_aeaint: Optional[int] = 20,
        max_neighbors_aint: Optional[int] = 1000,
        enforce_max_neighbors_strictly: bool = True,
        rbf: dict = {"name": "gaussian"},
        rbf_spherical: Optional[dict] = None,
        envelope: dict = {"name": "polynomial", "exponent": 5},
        cbf: dict = {"name": "spherical_harmonics"},
        sbf: dict = {"name": "legendre_outer"},
        extensive: bool = True,
        ...
        atom_interaction: bool = True,
        scale_basis: bool = False,
        qint_tags: list = [1, 2],
        num_elements: int = 83,
        otf_graph: bool = False,
        scale_file: Optional[str] = "gemnet-oc.pt",
        **kwargs,  # backwards compatibility with deprecated arguments
        ...
        scale_file = os.path.join(os.path.dirname(__file__), scale_file )
    ...
    def generate_graph(self, data):
        ...
        cell_offset_distances = torch.zeros_like(
            cell_offsets, device=data["R"].device
        )
